...
class Penjualan extends BaseController
{
    ...
    private $produk, $cart, $karyawan, $penjualan, $detailPenjualan, $income;
    ...
    public function index()
    {
        ...
        $dataProduk = $this->produk->getProduk();
        $dataKaryawan = $this->karyawan->getKaryawan();
        $dataPenjualan = $this->penjualan->getPenjualan1();
        // dd($dataPenjualan);
        $data = [
            'title' => 'penjualan',
            'dataProduk' => $dataProduk,
            'dataKaryawan' => $dataKaryawan,
            'result' => $dataPenjualan,
        ];
    ...
    {
        $dataPenjualan = $this->penjualan->getPenjualan1($id);
        $data = [
