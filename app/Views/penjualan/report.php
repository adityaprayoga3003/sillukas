    ...
    <div class="container-fluid px4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="/penjualan/laporan/filter" method="post">
                    <div class="container">
                        <div class="row">
                            <div class="col-4">
                ...
                <br>
                <!-- isi Report -->
                <a target="_blank" class="btn btn-danger mb-3" type="button" href="/penjualan/exportpdf"><i class="fas fa-file-pdf"></i></a>
                <a class="btn btn-success mb-3" type="button" href="/penjualan/exportexcel"><i class="fas fa-file-excel"></i></a>
