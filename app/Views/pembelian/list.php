...
<?= $this->include('pembelian/modal-karyawan') ?>
<script>
    function load() {
        $('#detail_cart').load("<?= base_url('pembelian/load') ?>");
        $('#spanTotal').load("<?= base_url('pembelian/gettotal') ?>");
