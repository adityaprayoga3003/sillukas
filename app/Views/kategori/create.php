        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('kategori/create') ?>" method="POST">
                    <?= csrf_field() ?>
                    <div class="mb-3 row">
                        <label for="nama_kategori" class="col-sm-2 col-form-label">Nama Kategori Cukur</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= $validation->hasError('nama_kategori') ? 'is-invalid'
