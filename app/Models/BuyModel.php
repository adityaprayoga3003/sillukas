...
class BuyModel extends Model
{
    ...
    public function getReport($tgl_awal, $tgl_akhir)
    {
        ...
        ->select('s.buy_id, s.created_at tgl_transaksi, us.id user_id, 
            us.firstname, us.lastname, , us.user_name, c.supplier_id, 
            c.name name_supp, c.no_supplier, SUM(sd.total_price) total')
        ->join('buy s', 'buy_id')
