...
class SaleModel extends Model
{
    ...
    public function getReport($tgl_awal, $tgl_akhir)
    {
        ...
        ->select('s.sale_id, s.created_at tgl_transaksi, us.id user_id, 
            us.firstname, us.lastname, , us.user_name, c.customer_id, 
            c.name name_cust, c.no_customer, SUM(sd.total_price) total')
        ->join('sale s', 'sale_id')
